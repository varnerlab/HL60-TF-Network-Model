function Convert_Model_multi(cell_line,model_num)
	...
	Species_Labels = [  "RAR"
		...
		cmd = ["load ./results/",cell_line,"/Model_",num2str(model_num),"_1/Model_",num2str(model_num),".dat;"];
		eval(cmd);
		...
		path_to_file = strcat("./results/",cell_line,"/Model_",num2str(model_num),"_1/Model_",num2str(model_num),"_new.sif");
