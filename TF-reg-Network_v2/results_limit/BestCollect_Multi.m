...
function [Best_Error_Matrix,Best_Paramater_Matrix,Best_Error_Indv_Matrix] = BestCollect_Multi(model_start,model_end,cell_line)
	...
	for i = model_start:model_end
		...
		cmd=['load ./',cell_line,'/Model_',num2str(i),'_3/MSE_Error_Array',num2str(i),'.dat;'];
		eval(cmd);
